...
imageJ (https://imagej.nih.gov/ij/) / sudo apt-get install imagej
...
En cas d'erreur, finissez l'image raté pour passer à la suivante, puis cliquez sur la roulette pour revenir à l'image raté.
